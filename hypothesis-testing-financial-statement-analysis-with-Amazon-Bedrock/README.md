...
```
cd existing_repo
git remote add origin https://gitlab.aws.dev/genai-for-capital-markets/hypothesis-testing-and-cause-effect-analysis-for-investment-research.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.aws.dev/genai-for-capital-markets/hypothesis-testing-and-cause-effect-analysis-for-investment-research/-/settings/integrations)
